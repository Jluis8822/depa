...
map.getView().fit([-8844511.264495, -762769.791952, -8705014.754599, -628193.488395], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Unidades Geológicas de Cutervo</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (15 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@Jorge Castillo';
            }
